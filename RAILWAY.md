...
- **Основной MCP эндпоинт:** `https://your-app.railway.app/mcp` (POST)
- **SSE альтернатива:** `https://your-app.railway.app/sse` 
- **Health check:** `https://your-app.railway.app/health`
- **Информация о сервере:** `https://your-app.railway.app/`

**Рекомендация:** Используйте `/mcp` для Poke, `/sse` как резервный вариант
...
**API Key:**
- Если настроен `MCP_AUTH_TOKEN`, используйте его значение как API Key
...
**Примечание:** `/mcp` использует HTTP POST (стандартный JSON-RPC), `/sse` использует Server-Sent Events
